...
describe('SignIn Page', () =>{
    ...
    it('shoud be able to sign in',async () =>{
        ...
        fireEvent.change( emailField, {target : { value: 'login@test.com'}});
    ...
    it('shoud display an error if login fails',async () =>{
        ...
        mockedSignIn.mockedImplementation(()=>{
            throw new Error();
        })
        ...
        fireEvent.change( passwordField, {target : { value: '123456'}});
        fireEvent.click( buttonElement);
        await wait(()=>{expect(mockedAddToast).toHaveBeenCalledWith(expect.objectContaining({type: 'error'}))});
    });
});     